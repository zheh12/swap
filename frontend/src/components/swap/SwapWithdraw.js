 ...
 * @returns 
 */
export function SwapWithdraw({withdraw}) {
    return (
        <div className="card p-3 mb-5">
            ...
            <form onSubmit = {(event) => {
                ...
                console.log("withdraw", tokenType, swapId, preimage);
                withdraw(tokenType, swapId, preimage);
            }}>
                <div className="mb-3">
                ...
                <div className="mb-3">
                    ...
                    <input type="password" name="preimage" className="form-control"></input>
                </div>
